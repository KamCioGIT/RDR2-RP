...
Config.CraftingsReceipe = {
    ...
    ['concoctionendurancedeux'] = {
        ...
        WorkingTime = 5,
        label = 'Essence de térébenthine',
        descriptionimages = {{src = 'nui://redemrp_inventory/html/items/water.png', text = "Semence bovine",count = "x1"}, {src = 'nui://redemrp_inventory/html/items/consumable_herb_red_raspberry.png', text = "Myrtille",count = "x3"},{src = 'nui://redemrp_inventory/html/items/consumable_herb_rams_head.png', text = "Pouledesbois",count = "x4"},{src = 'nui://redemrp_inventory/html/items/yeast.png', text = "sucre",count = "x1"}}
    },

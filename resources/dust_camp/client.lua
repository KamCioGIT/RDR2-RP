...
RegisterNetEvent("camp:OpenCampMenu", function(menutype)
    ...
    TriggerEvent("redemrp_menu_base:getData", function(MenuData)
        ...
        if _menutype == 'fire' then 
            table.insert(elements, {label = "Gros Steak cuit", value = 'steak', descriptionimages = {src = "redemrp_inventory/html/items/provision_meat_prime_beef.png", text = "Gros Steak",count = "x1"}})
        end

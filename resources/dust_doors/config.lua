...
Config.Doors = {
    ...
    {
        door = 1730262833, ---- poste blackwater
        CloseRotation = -90.0,
        OpenCoord  = vector3(-877.09600830078,-1326.3577880859,42.957370758057),
        door2 = 0,
        CloseRotation2 = 0,
        locked = true,
        breakable = false, 
    ...
    {
        door = 1335840261, ---- poste straw
        CloseRotation = 60.0,
        OpenCoord  = vector3(-1763.1743164063,-382.84286499023,156.74990844727),
        door2 = 0,
        CloseRotation2 = 0,
        locked = true,
        breakable = false, 
    ...
    {
        door = 1405538538, ---- poste rhodes
        CloseRotation = -45.0,
        OpenCoord  = vector3(1228.2432861328,-1294.1765136719,75.914482116699),
        door2 = 0,
        CloseRotation2 = 0,
        locked = true,
        breakable = false, 
    ...
    {
        door = 1915401053, ---- poste rhodes
        CloseRotation = -65.0,
        OpenCoord  = vector3(2745.9448242188,-1397.6851806641,45.181930541992),
        door2 = 0,
        CloseRotation2 = 0,
        locked = true,
        breakable = false, 
    ...
    ---- tabac rhodes
        {
            door = 3929468747,
            CloseRotation = 145.0,
            OpenCoord  = vector3(1136.9982910156,-977.45391845703,68.385864257813),
            door2 = 0,
            CloseRotation2 = 0,
            locked = true,
            breakable = false, 
    ...
    ---- ecurie st denis
        {
            door = 865213245,
            CloseRotation = 0.0,
            DoorCoord = vector3(2511.7067871094,-1465.0637207031,45.310657501221),
            OpenCoord = vector3(2514.102, -1465.01, 45.32796),
            door2 = 1797818933,
            CloseRotation2 = 183.0,
            DoorCoord2 = vector3(2516.1127929688,-1465.0637207031,45.310657501221),
            locked = true,
            breakable = false, 
            jobs = {"marechal_stdenis"},
            keys = false,
        },
        {
            door = 2744560757,
            CloseRotation = 183.0,
            DoorCoord = vector3(2504.5302734375,-1465.0637207031,45.310657501221),
            OpenCoord = vector3(2502.33, -1465.23, 45.32698),
            door2 = 293111919,
            CloseRotation2 = 0.0,
            DoorCoord2 = vector3(2500.1242675781,-1465.0637207031,45.310657501221),
            locked = true,
            breakable = false, 
            jobs = {"marechal_stdenis"},
            keys = false,
        },
        {
            door = 1388233219,
            CloseRotation = 90.0,
            DoorCoord = vector3(2499.3371582031,-1452.4425048828,45.310657501221),
            OpenCoord = vector3(2499.34, -1450.398, 45.3269),
            door2 = 1234907076,
            CloseRotation2 = -90.0,
            DoorCoord2 = vector3(2499.3371582031,-1448.0364990234,45.310657501221),
            locked = true,
            breakable = false, 
            jobs = {"marechal_stdenis"},
            keys = false,
        },
        {
            door = 229021101,
            CloseRotation = 0.0,
            DoorCoord = vector3(2500.1242675781,-1435.3176269531,45.310657501221),
            OpenCoord = vector3(2502.445, -1435.209, 45.32063),
            door2 = 726257907,
            CloseRotation2 = -183.0,
            DoorCoord2 = vector3(2504.5302734375,-1435.3176269531,45.310657501221),
            locked = true,
            breakable = false, 
            jobs = {"marechal_stdenis"},
            keys = false,
        ...
        ---- ecurie blackwater
        {
            door = 2434163029,
            CloseRotation = -5.0,
            DoorCoord = vector3(-875.84710693359,-1359.9681396484,42.563671112061),
            OpenCoord = vector3(-873.6193, -1360.938, 42.53397),
            door2 = 2723054453,
            CloseRotation2 = 180.0,
            DoorCoord2 = vector3(-871.66180419922,-1359.9683837891,42.563671112061),
            locked = true,
            breakable = false, 
            jobs = {"marechal_bla"},
            keys = false,
        },
        {
            door = 3317385806,
            CloseRotation = -90.0,
            DoorCoord = vector3(-856.44091796875,-1364.1910400391,42.563453674316),
            OpenCoord = vector3(-857.06, -1366.466, 42.53474),
            door2 = 3010471352,
            CloseRotation2 = 90.0,
            DoorCoord2 = vector3(-856.44085693359,-1368.3760986328,42.563453674316),
            locked = true,
            breakable = false, 
            jobs = {"marechal_bla"},
            keys = false,
    ...
    ----mine
        {
            door = 2703965258,
            CloseRotation = -20.0,
            OpenCoord  = vector3(2921.7209472656,1380.9013671875,55.260143280029),
            door2 = 0,
            CloseRotation2 = 0,
            locked = true,
            breakable = false, 
        ...
        },
        {
            door = 2543667965,
            CloseRotation = 70.0,
            OpenCoord  = vector3(2926.0666503906,1376.6920166016,55.210140228271),
            door2 = 0,
            CloseRotation2 = 0,
            locked = true,
            breakable = false, 

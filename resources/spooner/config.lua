...
if Config.isRDR then
	...
	Config.ForwardControl         = `INPUT_FRONTEND_LS` -- W 
	Config.BackwardControl        = `INPUT_MOVE_DOWN_ONLY` -- S
	Config.LeftControl            = `INPUT_FRONTEND_LB` -- A 
	...
	Config.AdjustUpControl        = `INPUT_EMOTE_TWIRL_GUN_VAR_B` -- Q
	Config.AdjustDownControl      = `INPUT_EMOTE_TWIRL_GUN_VAR_A` -- Z 

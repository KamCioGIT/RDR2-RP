...
RegisterNetEvent('dust:sleeves', function(source, args, rawCommand)
    ...
    Citizen.Wait(2000)
	if not sleeves then 
		Citizen.InvokeNative(0x66B957AAC2EAAEAB, PlayerPedId(), hash, GetHashKey("Closed_Collar_Rolled_Sleeve"), 0, true, 1)
		Citizen.InvokeNative(0xCC8CA3E88256E58F, PlayerPedId(), 0, 1, 1, 1, false)
		sleeves = true
	else
		Citizen.InvokeNative(0x66B957AAC2EAAEAB, PlayerPedId(), hash, GetHashKey("base"), 0, true, 1)
...
RegisterNetEvent('dust:boots', function(source, args, rawCommand)
    ...
    if Citizen.InvokeNative(0xFB4891BD7578CDC1, PlayerPedId(), 0x777EC6EF) then
        ...
        play_anim('mech_loco_m@character@arthur@fidgets@insects@crouch@unarmed@idle', 'idle', 1000, 1)
        Citizen.Wait(1000)
        Citizen.InvokeNative(0xD3A7B003ED343FD9, PlayerPedId(), hash, true, true, false);
    end
...
RegisterNetEvent('dust:pants', function(source, args, rawCommand)
    ...
    if Citizen.InvokeNative(0xFB4891BD7578CDC1, PlayerPedId(), 0xA0E3AB7F) then
        ...
        Citizen.InvokeNative(0xD3A7B003ED343FD9, PlayerPedId(), GetClothesCurrentComponentHash("skirts"), true, true, false);
    end
    Citizen.InvokeNative(0xCC8CA3E88256E58F, PlayerPedId(), 0, 1, 1, 1, 0)
end)

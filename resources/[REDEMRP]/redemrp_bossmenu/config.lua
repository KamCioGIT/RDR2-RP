...
----- ----- ----- -----
   ...
   ---- MALIWEN
    ...
    ["chasse_est"] = {
        bigjob = "chasse",
        MenuLocations = vector3(2817.19, -1323.963, 45.59243),
...
Config.Export = {
    ["Blackwater"] = {
        ...
        ["ferpepite"] = {label= "Pépite de fer", price= 0.09},
        ["charbon"] = {label= "Charbon", price= 0.04},
        ["cuivrepepite"] = {label= "Pépite de cuivre", price= 0.06},
        ["plombpepite"] = {label= "Pépite de plomb", price= 0.06},
        ["zincpepite"] = {label= "Pépite de zinc", price= 0.24},
        ["good_whisky"] = {label= "Whisky", price= 0.16},
        ["dirty_whiskey"] = {label= "Mauvais Whisky", price= 0.11},

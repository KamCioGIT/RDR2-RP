...
AddEventHandler('sellnpc:addAlert', function (coords)
    ...
    Citizen.InvokeNative(0x9CB1A1623062F402, blip, "Affaire louche")
...
AddEventHandler('braquage:addAlert', function (coords)
    local blip = Citizen.InvokeNative(0x554D9D53F696D002, 1482572802, coords.x, coords.y, coords.z)
    local radius = Citizen.InvokeNative(0x45F13B7E0A15C880, 1247852480, coords.x, coords.y, coords.z, Config.blipRadius)

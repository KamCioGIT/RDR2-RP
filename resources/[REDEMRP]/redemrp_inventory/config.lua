...
["tabacchiquermenthe"] = {
    ...
    description = "Du bon tabac parfumé à la menthe",
    weight = 0.1,
    canBeDropped = true,
    canBeUsed = true,
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/buffed_chewing_tobacco.png",
    type = "item_standard",
},
["lemonade"] = {
    label = "Limonade",
...
["cigarettesdesert"] = {
    ...
    description = "Une petite blonde parfumé à la sauge",
    weight = 0.1,
    canBeDropped = true,
    canBeUsed = true,
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/consumable_cigarette_box.png",
    type = "item_standard",
},
["cigarettechanvre"] = {
...
["moonshine"] = {
    label = "Moonshine",
    description = "L'alcool du grand-père",
    weight = 0.1,
    canBeDropped = true,
    canBeUsed = true,
    requireLvl = 0,
...
["moonshinebayou"] = {
    label = "Moonshine du Bayou",
    description = "L'odeur des marais",
    weight = 0.1,
    canBeDropped = true,
    canBeUsed = true,
    requireLvl = 0,
...
["moonshinetrappeur"] = {
    label = "Moonshine du Trappeur",
    description = "Distillée dans nos forêts",
    weight = 0.1,
    canBeDropped = true,
    canBeUsed = true,
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/blackcurrant_moonshine.png",
    type = "item_standard",
},
["moonshinecueilleur"] = {
    label = "Moonshine du Cueilleur",
    description = "",
    weight = 0.1,
    canBeDropped = true,
    canBeUsed = true,
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/raspberry_moonshine.png",
    type = "item_standard",
},
["moonshineforet"] = {
    label = "Moonshine de la Forêt",
    description = "",
    weight = 0.1,
    canBeDropped = true,
    canBeUsed = true,
...
["moonshinecitadin"] = {
    label = "Moonshine du Citadin",
    description = "Eux aussi ont du talent",
    weight = 0.1,
    canBeDropped = true,
    canBeUsed = true,
    requireLvl = 0,
...
["moonshinepeignecul"] = {
    label = "Moonshine du Peigne cul",
    description = "Sans goût et sans saveur",
    weight = 0.1,
    canBeDropped = true,
    canBeUsed = true,
    requireLvl = 0,
...
["moonshinemexicaine"] = {
    label = "Moonshine Mexicaine",
    description = "L'alcool des desperados",
    weight = 0.1,
    canBeDropped = true,
    canBeUsed = true,
    requireLvl = 0,
...
["aromebayou"] = {
    ...
    description = "Un concentré de Bayou",
    weight = 0.1,
    canBeDropped = true,
    canBeUsed = false,
    requireLvl = 0,
...
["arometrappeur"] = {
    ...
    description = "On reconnait là un vrai chasseur",
    weight = 0.1,
    canBeDropped = true,
    canBeUsed = false,
    requireLvl = 0,
...
["aromecueilleur"] = {
    ...
    description = "Les balades en forêt ont du bon",
    weight = 0.1,
    canBeDropped = true,
    canBeUsed = false,
    requireLvl = 0,
...
["aromeforet"] = {
    ...
    description = "Un concentré forestier",
    weight = 0.1,
    canBeDropped = true,
    canBeUsed = false,
    requireLvl = 0,
...
["aromefongique"] = {
    ...
    description = "Un concentré de champignon",
    weight = 0.1,
    canBeDropped = true,
    canBeUsed = false,
    requireLvl = 0,
...
["aromecitadin"] = {
    ...
    description = "Pour les vrais rats",
    weight = 0.1,
    canBeDropped = true,
    canBeUsed = false,
    requireLvl = 0,
...
["aromepeignecul"] = {
    ...
    description = "Un concentré d'ennui",
    weight = 0.1,
    canBeDropped = true,
    canBeUsed = false,
    requireLvl = 0,
...
["resinepavot"] = {
    ...
    description = "Une résine brunâtre",
    weight = 0.1,
    canBeDropped = true,
    canBeUsed = false,
    requireLvl = 0,
...
["pipeopium"] = {
    label = "Pipe d'opium",
    description = "Des vertues apaisantes",
    weight = 0.1,
    canBeDropped = true,
    canBeUsed = true,
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/kit_tobacco_pipe.png",
    type = "item_standard",
},
["cigaretteopium"] = {
...
["morphine"] = {
    label = "Morphine",
    description = "Permet d'apaiser la douleur",
    weight = 0.1,
    canBeDropped = true,
    canBeUsed = true,
    requireLvl = 0,
...
["heroine"] = {
    label = "Héroïne",
    description = "Permet de traiter la toux",
    weight = 0.1,
    canBeDropped = true,
    canBeUsed = true,
    requireLvl = 0,
...
["chaux"] = {
    label = "Chaux",
    description = "Une drôle de poudre",
    weight = 0.1,
    canBeDropped = true,
    canBeUsed = false,
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/ore_coal.png",
    type = "item_standard",
},
["alambic"] = {
    label = "Alambic",
    description = "Un gros cylindre de cuivre",
    weight = 30,
    canBeDropped = true,
    canBeUsed = false,
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/moonshinestill.png",
    type = "item_standard",
},
["corpsalambic"] = {
...
["condenseuralambic"] = {
    ...
    description = "Un tuyau en cuivre",
    weight = 10,
    canBeDropped = true,
    canBeUsed = false,
    requireLvl = 0,
...
["watch1"] = {
    ...
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/provision_pocket_watch_reutlinge.png",
    type = "item_standard",
},
["watch2"] = {
    ...
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/valuable_watch5.png",
    type = "item_standard",
},
["watch3"] = {
    ...
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/valuable_watch2.png",
    type = "item_standard",
},
["watch4"] = {
    label = "Montre en argent",
    ...
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/valuable_watch14.png",
    type = "item_standard",
},
["watch5"] = {
    ...
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/valuable_watch9.png",
    type = "item_standard",
},
["watch6"] = {
    ...
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/provision_watch.png",
    type = "item_standard",
},
["watch7"] = {
    label = "Montre en or",
    ...
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/provision_pocket_watch_silver.png",
    type = "item_standard",
},
["watch8"] = {
    ...
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/provision_rc_slvcatcher_watch.png",
    type = "item_standard",
},
["watch9"] = {
...
["clefpavotouest"] = {
    ...
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/clefpavotouest.png",
    type = "item_standard",
},
["clefpavotest"] = {
    label = "Clé",
...
["cartetrefle"] = {
    label = "As de trèfle",
    description = "Intrigant As de trèfle d'un jeu de carte",
    weight = 0.05,
    canBeDropped = true,
    canBeUsed = false,
    requireLvl = 0,
...
["a_c_fishbluegil_01_ms"] = {
    label = "Crapet arlequin",
    description = "De taille moyenne",
    weight = 0.3,
    canBeDropped = true,
    canBeUsed = false,
    requireLvl = 0,
...
["a_c_fishbluegil_01_sm"] = {
    label = "Petit Crapet arlequin",
    description = "De petite taille",
    weight = 0.15,
    canBeDropped = true,
    canBeUsed = false,
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/provision_fish_bluegill2.png",
    type = "item_standard",
},
["a_c_fishbullheadcat_01_ms"] = {
    ...
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/provision_fish_bullhead_catfish.png",
    type = "item_standard",
},
["a_c_fishbullheadcat_01_sm"] = {
    label = "Petit Poisson-chat",
    description = "De petite taille",
    weight = 0.15,
    canBeDropped = true,
    canBeUsed = false,
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/provision_fish_bullhead_catfish2.png",
    type = "item_standard",
},
["a_c_fishchainpickerel_01_ms"] = {
    label = "Brochet maillé",
    description = "De taille moyenne",
    weight = 0.3,
    canBeDropped = true,
    canBeUsed = false,
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/provision_fish_chain_pickerel.png",
    type = "item_standard",
},
["a_c_fishchainpickerel_01_sm"] = {
    label = "Petit Brochet maillé",
    description = "De petite taille",
    weight = 0.2,
    canBeDropped = true,
    canBeUsed = false,
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/provision_fish_chain_pickerel2.png",
    type = "item_standard",
},

["a_c_fishchannelcatfish_01_lg"] = {
    label = "Gros Barbue de rivière",
    description = "Un grosse taille",
    weight = 0.6,
    canBeDropped = true,
    canBeUsed = false,
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/provision_fish_channel_catfish.png",
    type = "item_standard",
},

["a_c_fishchannelcatfish_01_xl"] = {
    label = "Très gros Barbue de rivière",
    description = "De très grosse taille",
    weight = 0.9,
    canBeDropped = true,
    canBeUsed = false,
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/provision_fish_channel_catfish2.png",
    type = "item_standard",
},

["a_c_fishlakesturgeon_01_lg"] = {
    label = "Gros Esturgeon jaune",
    ...
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/provision_fish_lake_sturgeon.png",
    type = "item_standard",
},

["a_c_fishlargemouthbass_01_lg"] = {
    label = "Gros Achigan à grande bouche",
    description = "De grosse taille",
    weight = 0.6,
    canBeDropped = true,
    canBeUsed = false,
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/provision_fish_largemouth_bass.png",
    type = "item_standard",
},

["a_c_fishlargemouthbass_01_ms"] = {
    label = "Achigan à grande bouche",
    description = "Un taille moyenne",
    weight = 0.3,
    canBeDropped = true,
    canBeUsed = false,
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/provision_fish_largemouth_bass2.png",
    type = "item_standard",
},
["a_c_fishlongnosegar_01_lg"] = {
    label = "Gros Lépisosté osseux",
    description = "De grosse taille",
    weight = 0.6,
    canBeDropped = true,
    canBeUsed = false,
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/provision_fish_longnose_gar.png",
    type = "item_standard",
},
["a_c_fishmuskie_01_lg"] = {
    label = "Gros Maskinongé",
    description = "De grosse taille",
    weight = 0.6,
    canBeDropped = true,
    canBeUsed = false,
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/provision_fish_muskie.png",
    type = "item_standard",
},
["a_c_fishnorthernpike_01_lg"] = {
    ...
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/provision_fish_northern_pike.png",
    type = "item_standard",
},
["a_c_fishperch_01_ms"] = {
    label = "Perche",
    ...
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/provision_fish_perch.png",
    type = "item_standard",
},
["a_c_fishperch_01_sm"] = {
    label = "Petite Perche",
    ...
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/provision_fish_perch2.png",
    type = "item_standard",
},
["a_c_fishrainbowtrout_01_lg"] = {
    label = "Grosse Truite arc-en-ciel",
    description = "De grosse taille",
    weight = 0.6,
    canBeDropped = true,
    canBeUsed = false,
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/provision_fish_speckled_trout.png",
    type = "item_standard",
},
["a_c_fishrainbowtrout_01_ms"] = {
    ...
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/provision_fish_speckled_trout2.png",
    type = "item_standard",
},
["a_c_fishredfinpickerel_01_ms"] = {
    ...
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/provision_fish_redfin_pickerel.png",
    type = "item_standard",
},
["a_c_fishredfinpickerel_01_sm"] = {
    label = "Petit Brochet rouge",
    description = "De petite taille",
    weight = 0.15,
    canBeDropped = true,
    canBeUsed = false,
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/provision_fish_redfin_pickerel2.png",
    type = "item_standard",
},
["a_c_fishrockbass_01_ms"] = {
    label = "Crapet de roche",
    description = "Un taille moyenne",
    weight = 0.3,
    canBeDropped = true,
    canBeUsed = false,
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/provision_fish_rock_bass.png",
    type = "item_standard",
},
["a_c_fishrockbass_01_sm"] = {
    label = "Petit Crapet de roche",
    description = "De petite taille",
    weight = 0.15,
    canBeDropped = true,
    canBeUsed = false,
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/provision_fish_rock_bass2.png",
    type = "item_standard",
},
["a_c_fishsalmonsockeye_01_lg"] = {
    label = "Très Gros Saumon rouge",
    description = "De très grosse taille",
    weight = 0.9,
    canBeDropped = true,
    canBeUsed = false,
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/provision_fish_sockeye_salmon.png",
    type = "item_standard",
},
["a_c_fishsalmonsockeye_01_ml"] = {
    label = "Gros Saumon rouge",
    description = "De grosse taille",
    weight = 0.6,
    canBeDropped = true,
    canBeUsed = false,
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/provision_fish_sockeye_salmon2.png",
    type = "item_standard",
},
["a_c_fishsalmonsockeye_01_ms"] = {
    ...
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/provision_fish_sockeye_salmon3.png",
    type = "item_standard",
},
["a_c_fishsmallmouthbass_01_lg"] = {
    ...
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/provision_fish_smallmouth_bass2.png",
    type = "item_standard",
},
["a_c_fishsmallmouthbass_01_ms"] = {
    ...
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/provision_fish_smallmouth_bass.png",
    type = "item_standard",
},
...
["p_baitBread01x"] = {
    label = "Bout de pain",
    description = "Un petit bout de pain",
    weight = 0.1,
    canBeDropped = true,
    canBeUsed = true,
    requireLvl = 0,
...
["p_baitCorn01x"] = {
    label = "Bout de Maïs",
    description = "Un petit bout de maïs",
    weight = 0.1,
    canBeDropped = true,
    canBeUsed = true,
    requireLvl = 0,
...
["p_baitCheese01x"] = {
    label = "Bout de fromage",
    description = "Un petit bout de fromage",
    weight = 0.1,
    canBeDropped = true,
    canBeUsed = true,
    requireLvl = 0,
...
["p_baitWorm01x"] = {
    label = "Vers de terre",
    description = "Le roi des lombrics",
    weight = 0.1,
    canBeDropped = true,
    canBeUsed = true,
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/worms_bait.png",
    type = "item_standard",
},
["p_baitCricket01x"] = {
    label = "Criquet",
    description = "Le roi des insectes",
    weight = 0.1,
    canBeDropped = true,
    canBeUsed = true,
    requireLvl = 0,
...
["p_finishdcrawd01x"] = {
    ...
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/upgrade_fsh_bait_crayfish.png",
    type = "item_standard",
},
["p_lgoc_spinner_v4"] = {
    label = "Leurre",
    description = "Pour le bon poisson",
    weight = 0.1,
    canBeDropped = true,
    canBeUsed = true,
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/upgrade_fsh_bait_lure_lake.png",
    type = "item_standard",
},
["p_lgoc_spinner_v6"] = {
    label = "Leurre",
    ...
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/upgrade_fsh_bait_leg_lure_lake.png",
    type = "item_standard",
},
...
["alliance"] = {
    ...
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/chainwithring.png",
    type = "item_standard",
},
["bouclesoreilles"] = {
    label = "Boucles d'oreilles",
    description = "Les bijoux de grand-mère",
    weight = 0.1,
    canBeDropped = true,
    canBeUsed = false,
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/provision_jewelery_drop_earring.png",
    type = "item_standard",
},
["obligations"] = {
    label = "Obligations",
    description = "Un titre financier",
    weight = 0.1,
    canBeDropped = true,
    canBeUsed = false,
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/document_disco_fortune.png",
    type = "item_standard",
},
["pierreprecieuse"] = {
    label = "Pierre précieuse",
    description = "Dis donc, ça brille !",
    weight = 0.1,
    canBeDropped = true,
    canBeUsed = false,
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/gem.png",
    type = "item_standard",
},
["bagueor"] = {
    label = "Bague en or",
    description = "Quel joli anneau",
    weight = 0.1,
    canBeDropped = true,
    canBeUsed = false,
    requireLvl = 0,
...
["dentor"] = {
    label = "Dent en or",
    description = "Celui qui l'a perdue doit être bien emmerdé",
    weight = 0.1,
    canBeDropped = true,
    canBeUsed = false,
    requireLvl = 0,
...
["sacbijoux"] = {
    label = "Sac de bijoux",
    description = "Comme un trésor de pirate",
    weight = 0.5,
    canBeDropped = true,
    canBeUsed = false,
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/jewelerybag.png",
    type = "item_standard",
},
["boucleceinture"] = {
    label = "Boucle de ceinture",
    description = "Faudrait pas le froc tombe",
    weight = 0.1,
    canBeDropped = true,
    canBeUsed = false,
    requireLvl = 0,
...
["peigneivoire"] = {
    label = "Peigne en ivoire",
    description = "Pour les mèches rebelles",
    weight = 0.2,
    canBeDropped = true,
    canBeUsed = false,
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/provision_hrlm_comb_ivory.png",
    type = "item_standard",
},
["epinglecheveux"] = {
    label = "Epingle à cheveux",
    description = "Un bien joli accessoire",
    weight = 0.2,
    canBeDropped = true,
    canBeUsed = false,
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/provision_hrlm_hairpin_metal.png",
    type = "item_standard",
},
["boitebijoux"] = {
    label = "Boîte à bijoux",
    description = "Une boite exquise renfermant une collection éblouissante",
    weight = 0.5,
    canBeDropped = true,
    canBeUsed = false,
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/provision_jewelery_box.png",
    type = "item_standard",
},
["brocheruby"] = {
    label = "Broche ornée d'un rubis",
    description = "Une broche élégante ornée d'un rubis resplendissant",
    weight = 0.2,
    canBeDropped = true,
    canBeUsed = false,
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/provision_marys_brooch.png",
    type = "item_standard",
},
["baguediamant"] = {
    label = "Bague sertie de diamants",
    description = "Un parfait mariage entre luxe et raffinement",
    weight = 0.1,
    canBeDropped = true,
    canBeUsed = false,
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/provision_marys_ring.png",
    type = "item_standard",
},
["rivierediamants"] = {
    label = "Rivière de diamants",
    description = "Une belle parure",
    weight = 0.2,
    canBeDropped = true,
    canBeUsed = false,
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/provision_necklace_platinuim.png",
    type = "item_standard",
},
["collierperles"] = {
    label = "Collier de perles",
    description = "Une parure de perles, chacune évoquant un éclat unique",
    weight = 0.2,
    canBeDropped = true,
    canBeUsed = false,
    requireLvl = 0,
    limit = 2000,
    imgsrc = "items/provision_necklace_pearl.png",
    type = "item_standard",
},
["diamant"] = {
    label = "Diamant",
    description = "Symbole de pureté et de rareté",
    weight = 0.1,
    canBeDropped = true,
    canBeUsed = false,
    requireLvl = 0,

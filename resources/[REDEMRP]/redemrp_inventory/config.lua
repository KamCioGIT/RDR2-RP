...
Config.Items = {
    ...
    ["petitefourure"] = {
        label = "Petite fourure",
        description = "Une petite fourure idéal pour la confection de chapeaux",
        weight = 0.1,
        canBeDropped = true,
        canBeUsed = false,
        requireLvl = 0,
    ...
    ["viandepetitmamifere"] = {
        label = "Viande de petit mamifere",

...
Config.TimerForCounter = 240 --This count your herbs in your client cache.  (seconds)
...
Config.Herbs = {
    ...
    ["s_inv_orleander01x"] = {
        ...
        blipName = "chanvre",
        coords = {
            {497.4674, 1125.376, 190.138, 40.0},

        },
        maxSpawn = 30,--How much props is cached
        propMax = 30,--Spawn max props on limit
        canGatherMore = 1,--How much you can gather 1 entity
        grounded = 0.0,--(Grounded bring entity more under ground if you have flying prop)

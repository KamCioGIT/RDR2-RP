if DiseasesConfig['gun2'] then
    local gun2 = Disease:new(DiseasesConfig['gun2'])
    ...
    function gun2:setPaused(paused)
    ...
    DiseasesManager:loadDisease(gun2)
end

if DiseasesConfig['arrow'] then
    local arrow = Disease:new(DiseasesConfig['arrow'])
    ...
    function arrow:setPaused(paused)
    ...
    DiseasesManager:loadDisease(arrow)
end

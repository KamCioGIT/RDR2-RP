if DiseasesConfig['gunscratch'] then
    local gunscratch = Disease:new(DiseasesConfig['gunscratch'])

    function gunscratch:init()
    ...
    function gunscratch:startEffect()
    ...
    function gunscratch:stopEffect()
        -- Set locomotion
    ...
    function gunscratch:setPaused(paused)
    ...
    DiseasesManager:loadDisease(gunscratch)
end

if DiseasesConfig['arrowscratch'] then
    local arrowscratch = Disease:new(DiseasesConfig['arrowscratch'])

    function arrowscratch:init()
    ...
    function arrowscratch:startEffect()
    ...
    function arrowscratch:stopEffect()
        -- Set locomotion
    ...
    function arrowscratch:setPaused(paused)
    ...
    DiseasesManager:loadDisease(arrowscratch)
end

if DiseasesConfig['meleescratch'] then
    local meleescratch = Disease:new(DiseasesConfig['meleescratch'])

    function meleescratch:init()
    ...
    function meleescratch:setPaused(paused)
    ...
    DiseasesManager:loadDisease(meleescratch)
end

...
Config.Price = {
    [GetHashKey("Strawberry")] = {
        ...
        ["cuir"] = {label="Cuir", price = 0.2},
        ["pepiteor"] = {label="Pépite d'or", price = 0.2},
        ["corne"] = {label="Corne", price = 0.2},
        ["graisse"] = {label="Morceau de gras", price = 0.2},
        ...
        ["patteours"] = {label="Patte d'ours", price = 0.5},
        ...
        ["barbane"] = {label="Barbane", price = 0.15},

...
Config.Price = {
    [GetHashKey("Strawberry")] = {
        ...
        ["corne"] = {label="Corne", price = 0.15},
        ["graisse"] = {label="Morceau de gras", price = 0.07},
        ["petitefourrure"] = {label="Petite fourrure", price = 0.15},
        ["peauecailles"] = {label="Peau à écailles", price = 0.15},
        ["plume"] = {label="Plume", price = 0.15}, 
        ["griffe"] = {label="Griffe", price = 0.15},
        ["bec"] = {label="Bec", price = 0.15},
        ["pincecrabe"] = {label="Pince de crabe", price = 0.15},
        ["serre"] = {label="Serre", price = 0.15},
        ["boiscerf"] = {label="Bois de cerf", price = 0.15},
        ["queuerenard"] = {label="Queue de renard", price = 0.4},
        ...
        ["patate"] = {label="Patate", price = 0.15},
        ["Corn"] = {label="Maïs", price = 0.15},
    },
    [GetHashKey("Rhodes")] = {
        ["moonshine"] = {label="Moonshine", price = 1},
        ["laitpavot"] = {label="Lait de Pavot", price = 1},

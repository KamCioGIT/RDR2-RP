...
Config.Price = {
    [GetHashKey("Strawberry")] = {
        ...
        ["barbane"] = {label="Bardane", price = 0.06},
        ["saugeducolibri"] = {label="Sauge du Colibri", price = 0.06},
        ["menthesauvage"] = {label="Menthe sauvage", price = 0.06},
        ["coulemelle"] = {label="Coulemelle", price = 0.06},
        ["asclepiade"] = {label="Asclépiade", price = 0.06},
        ["ginseng"] = {label="Ginseng", price = 0.06},
        ["millefeuille"] = {label="Millefeuille", price = 0.06},
        ["pouledesbois"] = {label="Poule des bois", price = 0.06},
        ["saugedudesert"] = {label="Sauge du desert", price = 0.06},
        ["jonccommun"] = {label="Jonc Commun", price = 0.06},
        ["achillevisqueuse"] = {label="Achillé Visqueuse", price = 0.06},
        ["camomillesauvage"] = {label="Camomille Sauvage", price = 0.06},
        ["boletbai"] = {label="Bolet-Baï", price = 0.06},
        ["baiedegaultherie"] = {label="Baie de Gaultherie", price = 0.06},

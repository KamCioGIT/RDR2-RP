...
Config.Price = {
    [GetHashKey("Strawberry")] = {
        ...
        ["moonshinemexicaine"] = {label="Moonshine Mexicaine", price = 2.7},
        ["moonshinebayou"] = {label="Moonshine du Bayou", price = 2.1},
        ["moonshinecueilleur"] = {label="Moonshine du Cueilleur", price = 1.9},
        ["moonshineforet"] = {label="Moonshine de la Forêt", price = 2.1},
        ["moonshinefongique"] = {label="Moonshine Fongique", price = 1.4},
        ["moonshinecitadin"] = {label="Moonshine du Citadin", price = 2.3},
        ["moonshinepeignecul"] = {label="Moonshine du Peigne cul", price = 1.2},
        ["laitpavot"] = {label="Lait de Pavot", price = 1.2},
        ["pipeopium"] = {label="Pipe d'opium", price = 0.8},
        ["cigaretteopium"] = {label="Cigarette d'opium", price = 0.9},
        ["cigarettechanvre"] = {label="Cigarette d'opium", price = 0.9},
        ["pavot"] = {label="Pavot", price = 0.35},
        ["morphine"] = {label="Morphine", price = 2.5},
        ["heroine"] = {label="Héroïne", price = 3.7},

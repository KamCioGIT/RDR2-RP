...
Config.Price = {
    [GetHashKey("Strawberry")] = {
        ["moonshine"] = {label="Moonshine", price = 0.72},
        ["moonshinemexicaine"] = {label="Moonshine Mexicaine", price = 2.54},
        ["moonshinebayou"] = {label="Moonshine du Bayou", price = 2.1},
        ["laitpavot"] = {label="Lait de Pavot", price = 1.21},
        ["pipeopium"] = {label="Pipe d'opium", price = 0.67},
        ["cigaretteopium"] = {label="Cigarette d'opium", price = 0.86},
        ["pavot"] = {label="Pavot", price = 0.34},
        ["morphine"] = {label="Morphine", price = 2.3},
        ["heroine"] = {label="Héroïne", price = 3.6},
        ["laudanum"] = {label= "Laudanum", price= 1.8},
        ["cuir"] = {label="Cuir", price = 0.05},
        ["pepiteor"] = {label="Pépite d'or", price = 0.04},
        ["corne"] = {label="Corne", price = 0.06},
        ["graisse"] = {label="Morceau de gras", price = 0.04},
        ["petitefourrure"] = {label="Petite fourrure", price = 0.06},
        ["peauecailles"] = {label="Peau à écailles", price = 0.06},
        ["plume"] = {label="Plume", price = 0.06}, 
        ["griffe"] = {label="Griffe", price = 0.05},
        ["bec"] = {label="Bec", price = 0.08},
        ["pincecrabe"] = {label="Pince de crabe", price = 0.08},
        ["serre"] = {label="Serre", price = 0.08},
        ["boiscerf"] = {label="Bois de cerf", price = 0.08},
        ["queuerenard"] = {label="Queue de renard", price = 0.21},
        ["peauvisqueuse"] = {label="Peau visqueuse", price = 0.06},
        ["dentrongeur"] = {label="Dent de rongeur", price = 0.06},
        ["defense"] = {label="Défense", price = 0.06},
        ["queuedecastor"] = {label="Queue de castor", price = 0.21},
        ["patteours"] = {label="Patte d'ours", price = 0.52},
        ["crocdecroco"] = {label="Dent de crocodile", price = 0.12},
        ["carapace"] = {label="Carapace", price = 0.08},
        ["peauserpent"] = {label="Peau de serpent", price = 0.11},
        ["croc"] = {label="Croc de loup", price = 0.06},
        ["concoctionendurance"] = {label="Essence de térébenthine", price = 0.73},
        ["concoctionanesthesiante"] = {label="Emulsion Anesthésiante", price = 0.72},
        ["concoctioncoagulation"] = {label="Solution Coagulante", price = 0.76},
        ["semencedetoreau"] = {label="Semence bovine", price = 0.4},
        ["patate"] = {label="Patate", price = 0.10},
        ["Corn"] = {label="Maïs", price = 0.10},
        ["filetpoisson"] = {label="Filet de poisson", price = 0.07},
        ["dirty_whiskey"] = {label="Mauvais Whisky", price = 0.13},
        ["good_whisky"] = {label="Whisky", price = 0.31},
        ["epismaisgrille"] = {label="Epis de maïs grillé", price = 0.36},
        ...
        ["bouteillelait"] = {label="Bouteille de lait", price = 0.22},
        ["tourteviande"] = {label="Tourte à la viande", price = 0.53},
        ["tourtepoisson"] = {label="Tourte au poisson", price = 0.53},
        ["soupechampignon"] = {label="Soupe aux Champignons", price = 0.46},
        ["caisseviande"] = {label= "Caisse de viande", price= 0.76},
        ["caissepoisson"] = {label= "Caisse de poisson", price= 0.76},     
    },
    [GetHashKey("Blackwater")] = {
        ...
        ["cigaretteopium"] = {label="Cigarette d'opium", price = 0.86},
        ["pavot"] = {label="Pavot", price = 0.34},
        ["morphine"] = {label="Morphine", price = 2.2},
        ["heroine"] = {label="Héroïne", price = 3.6},
        ["laudanum"] = {label= "Laudanum", price= 1.8},
        ["cuir"] = {label="Cuir", price = 0.05},
        ["pepiteor"] = {label="Pépite d'or", price = 0.04},
    ...
    [GetHashKey("Rhodes")] = {
        ...
        ["moonshinebayou"] = {label="Moonshine du Bayou", price = 2.5},
        ...
        ["laudanum"] = {label= "Laudanum", price= 2},

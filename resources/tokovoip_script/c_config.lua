TokoVoipConfig = {
	...
	keyProximity = 0xD8F73058, -- Keybind used to switch the proximity mode
	...
	plugin_data = {
		...
		TSChannel = "Vocal",
		TSPassword = "ingamedust", -- TeamSpeak channel password (can be empty)
		...
		localName = "ID", -- If set, this name will be used as the user's teamspeak display name

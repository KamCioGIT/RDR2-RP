...
function populateBanking(data)
{
    ...
    if(data.statement !== undefined) {
        ...
        $("#currentStatementContents").append('<tr class="statement"><td><small style="letter-spacing:1px">' + isoDatenew + '</small></td><td><small>' + statement.type + '</small></td><td class="text-center text-danger"><small>$' + withdraw + '</small></td><td class="text-center text-success"><small>$' + deposit + '</small></td><td class="text-center"><small>' + balance + '</small></td></tr>');

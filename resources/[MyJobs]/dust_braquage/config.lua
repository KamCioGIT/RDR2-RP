...
--     ["large"] = {
        ------ ST DENIS ------
        {difficulty = "hard", pos = vector3(2640.915, -1301.931, 51.24611), cashmax = 50, cashmin = 20, items = {
            ["lingotor"] = {amount = 1, chance = 25},
            ["lingotfer"] = {amount = 2, chance = 50},
        }}, -- ST DENIS hard
        {difficulty = "hard", pos = vector3(2642.037, -1304.28, 51.24611), cashmax = 50, cashmin = 20, items = {
            ["lingotor"] = {amount = 1, chance = 25},
            ["lingotfer"] = {amount = 2, chance = 50},
        }}, -- ST DENIS hard
        {difficulty = "hard", pos = vector3(2643.008, -1306.359, 51.24611), cashmax = 50, cashmin = 20, items = {
            ["lingotor"] = {amount = 1, chance = 25},
            ["lingotfer"] = {amount = 2, chance = 50},
        }}, -- ST DENIS hard
        {difficulty = "hard", pos = vector3(2645.373, -1306.043, 51.24611), cashmax = 50, cashmin = 20, items = {
            ["lingotor"] = {amount = 1, chance = 25},
            ["lingotfer"] = {amount = 2, chance = 50},
        }}, -- ST DENIS hard
        {difficulty = "hard", pos = vector3(2644.774, -1304.288, 51.24611), cashmax = 50, cashmin = 20, items = {
            ["lingotor"] = {amount = 1, chance = 25},
            ["lingotfer"] = {amount = 2, chance = 50},
        }}, -- ST DENIS hard

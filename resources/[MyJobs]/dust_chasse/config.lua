...
{    
    ...
    vector3(2996.416, 565.5698, 43.95896) ---- Van Horn
}

Config.Relais = 
{    
    vector3(-1982.628, -1619.964, 118.0835),-- Manzanita
    vector3(2999.179, 563.036, 44.76215) -- Van Horn
}

Config.Craftcuir = {vector3(-1970.758, -1641.776, 117.1183), vector3(-92.08035, 1552.082, 115.7228), vector3(-1972.92, -1634.835, 117.2469), vector3(3000.897, 561.8671, 43.48987)}

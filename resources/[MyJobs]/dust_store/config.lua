...
Config.CraftingsReceipe = {
    ...
    ['gateau'] = {
        ...
        WorkingTime = 5,
        label = 'Gâteau',
        descriptionimages = {{src = 'nui://redemrp_inventory/html/items/consumable_offal.png', text = "Bouteille de lait",count = "x1"}, {src = 'nui://redemrp_inventory/html/items/flour.png', text = "Farine",count = "x1"}, {src = 'nui://redemrp_inventory/html/items/yeast.png', text = "Sucre",count = "x1"}, {src = 'nui://redemrp_inventory/html/items/rock.png', text = "Charbon",count = "x1"}}
    },
    ['tartemyrtille'] = {
        type = 'epicerie',
        Itemtocraft = 4,
        ...
        descriptionimages = {{src = 'nui://redemrp_inventory/html/items/consumable_offal.png', text = "Bouteille de lait",count = "x1"}, {src = 'nui://redemrp_inventory/html/items/flour.png', text = "Farine",count = "x1"}, {src = 'nui://redemrp_inventory/html/items/consumable_herb_red_raspberry.png', text = "Myrtille",count = "x3"}, {src = 'nui://redemrp_inventory/html/items/rock.png', text = "Charbon",count = "x1"}}
    },
    ['carrottecake'] = {
        type = 'epicerie',
        Job = 'store_stdenis',
    ...
    ['cerfbiere'] = {
        ...
        Job = 'store_rhodes',
        Itemtocraft = 4,
        ItemReceipe1Name = 'beer',
        ItemReceipe1Amount = 1,
        ItemReceipe2Name = 'patate',
        ItemReceipe2Amount = 1,
        ItemReceipe3Name = 'viandegibier',
        ItemReceipe3Amount = 3,
        ItemReceipe4Name = 'charbon',
        ItemReceipe4Amount = 1,

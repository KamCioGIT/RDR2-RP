...
Config.DamageModifier = {
    ...
    [-1783478894]                        = 0.9,          -- weapon_repeater_henry = litchfield 8 balles
    [-1471716628]                        = 0.9,          -- weapon_repeater_winchester = lancaster 8 balles
    [-183018591]                        = 0.9,          -- weapon_repeater_carbine = carbine 8 balles

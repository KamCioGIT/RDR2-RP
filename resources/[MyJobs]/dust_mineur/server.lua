...
Citizen.CreateThread(function()
	while true do
		...
		Citizen.Wait(2000)
		TriggerEvent("redemrp_inventory:server:removeitemstash", "cuivrebrut", 1, {}, "dep_mineur","cuivrepepite", 5, {}, "ret_mineur")
		Citizen.Wait(2000)
		TriggerEvent("redemrp_inventory:server:removeitemstash", "plombbrut", 1, {}, "dep_mineur","plombpepite", 5, {}, "ret_mineur")
		Citizen.Wait(2000)
		TriggerEvent("redemrp_inventory:server:removeitemstash", "zincbrut", 1, {}, "dep_mineur","zincpepite", 3, {}, "ret_mineur")
		Citizen.Wait(2000)
		TriggerEvent("redemrp_inventory:server:removeitemstash", "charbonbrut", 1, {}, "dep_mineur","charbon", 4, {}, "ret_mineur")
	end
end)
